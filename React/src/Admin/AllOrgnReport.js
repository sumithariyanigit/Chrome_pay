                          ...
                          <form onSubmit={(e) => AddFormData(e)}>
                            <div className="rounded d-flex flex-column flex-lg-row mend align-items-lg-center bg-body p-5  h-lg-60px me-lg-10 my-5">
                              <div className="row flex-grow-1 mb-5 mb-lg-0">
                                <div className="col-lg-7 d-flex input-container align-items-center mb-3  mb-lg-0">
                                ...
                                <div className="col-lg-5 d-flex align-items-center mb-3 input-container mb-lg-0">
                                  <label className="small_label">
                                    End Date
                                  </label>
                                  <span className="svg-icon svg-icon-1 svg-icon-gray-400 me-1">
                                  ...
                                  <input
                                    type="date"
                                    className="form-control unstyled form-control-flush flex-grow-1 p-0"
                                    name="toDate"
                                    placeholder="to Date.."
                                  />
                                </div>
                              ...
                              <div className="min-w-150px d-flex ms-5">
                                <button
                                  type="submit"
                                  className="btn  btndesignorg"
                                  id="kt_advanced_search_button_1"
                                >
                                 <i className="fad fa-search" style={{fontSize:"1.5rem"}}></i>
                                </button>
                              </div>
                            </div>
                          </form>
