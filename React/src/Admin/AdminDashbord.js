...
function AdminDashboard() {
    ...
    const userlist = async() =>{
        await axios.get(`/admindash`)
        .then(resp=>{
            let data = resp.data.dashData;
            setData(data);
            console.log(data);
        })
...
//    console.log(recent.totalCustomer);
    const resentuserlist = async ()=>{
        await axios.get(`/recentUser`)
        .then(resp=>{
                                    ...
                                    <div className="card card-flush">
                                        ...
                                        <div className="bg_div card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px">
                                            ...
                                            <h3 className="card-title align-items-start flex-column text-white pt-15">
                                                <span className="fw-bold fs-2x mb-3">Admin Dashboard</span>
                                                ...
                                                <div className="row g-3 g-lg-6">
                                                    ...
                                                    <div className="col-6">
                                                        ...
                                                        <div className="retative bg-gray-100 ative animestion-bank bg-opacity-70 rounded-2 px-6 py-5">
                                                            ...
                                                            <div className="m-0">
                                                                <span data-kt-countup="true" data-kt-countup-value={data.totalUser} className="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">
                                                                    {data.totalUser}</span>
                                                    ...
                                                    <div className="col-6">
                                                        ...
                                                        <div className="retative bg-gray-100 animestion-bank bg-opacity-70 rounded-2 px-6 py-5">
                                                            ...
                                                            <div className="m-0">
                                                                <span data-kt-countup="true" data-kt-countup-value={`$${data.totlaTransection}`} data-kt-countup-prefix="$" className="text-gray-700  fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">
                                                                {`$${data.totlaTransection}`}</span>
                                                                <span className="text-gray-500 fw-semibold fs-6">
                                                    ...
                                                    <div className="col-6">
                                                        ...
                                                        <div className="retative bg-gray-100 animestion-bank bg-opacity-70 rounded-2 px-6 py-5">
                                                            ...
                                                            <div className="m-0">
                                                                <span data-kt-countup="true" data-kt-countup-value={data.totlaLicense} className="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">
                                                                    {data.totlaLicense}</span>
                                                                <span className="text-gray-500 fw-semibold fs-6">
                                                                    Total License </span>
                                                            </div>
                            ...
                            <div className="card bg_card rounded-15 bgi-no-repeat bgi-position-x-end bgi-size-cover"
                                ...
                                <div className="card-body container-xxl pt-10 pb-8">
                                    ...
                                    <div className="d-flex align-items-center">
                                        <h1 className="fw-semibold me-3 text-white">Recent</h1>
                                        <span className="fw-semibold text-white opacity-50">Users / Transaction</span>
                                    </div>
                ...
                <div className="card card-xxl-stretch mb-5 mb-xl-8">
                    ...
                    <div className="card-header border-0 pt-5">
                        <h3 className="card-title align-items-start flex-column">
                            ...
                            <span className="text-muted mt-1 fw-semibold fs-7">Over {recnttran} Customer</span>
                        </h3>
