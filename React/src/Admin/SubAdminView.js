...
//   console.log(ID);
    ...
    const AddFormData = async (e) => {
        ...
        axios.post(`/updateSubAdminRoles/${subAdminID}`, formData)
    ...
    const userlist = async () =>{
        ...
        .then(resp =>{
            ...
            setDataCustomer(CustomerChecked);
            //  setIsChecked(data.customer.addCustomer);
            // setIsChecked1(data.customer.editCustomer)
            console.log(data)
        })
    }
    // console.log("====",isChecked,isChecked1);

    useEffect(() => {
     userlist();
     handleOnChangeCustomer();
     handleOnChangeEditCustomer();
    }, [])
...
//     setCustomer(customer.addCustomer);
//   const[adtrue, setCustomer]=useState(true)
                                        ...
                                        <div className="row">
                                            <div className="col-lg-6 mb-6">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div class="col-lg-2 form-check form-switch  ">
                                                      <input class="form-check-input mt-5" type="checkbox" checked={customer.addCustomer == '1'}  name="addCustomer" defaultValue={isChecked}  role="switch" id="flexSwitchCheckDefault" onChange={(e) => handleOnChangeCustomer(e)}  />
                                            ...
                                            <div className="col-lg-6 mb-6">
                                                <div className="row">
                                                    ...
                                                    <div class="col-lg-2 form-check form-switch  ">
                                                    <input class="form-check-input mt-5" type="checkbox"  checked={agreement1} name="editCustomer"  value={isChecked1}  role="switch" id="flexSwitchCheckDefault" onChange={(e) => handleOnChangeEditCustomer(e)} />
