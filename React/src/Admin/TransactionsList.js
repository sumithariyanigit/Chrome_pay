...
export default function CustomerTranstionList() {
    ...
    const AddFormData = async (e, page) => {
        e.preventDefault();
            ...
            axios.post(`/admintransectionfillter/${adminID}`,formData)
            .then(resp =>{
    ...
    const userlist = async () =>{
        await axios.post(`/admintransectionfillter/${adminID}`)
        .then(resp => {
...
const fetchComments = async (page) =>{
    ...
    axios.post(`/admintransectionfillter/${adminID}`,sentdata)
    .then(resp =>{
        const data = resp.data.filter;
        setData(data);
    })
...
const handleView = (_id) => {
    console.log(_id);
    window.location =`/transaction-view-admin/${_id}`;
    return false;
}
                                            ...
                                            <table className="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> {item.PCN} </td>
                                                        <td>{item.PayInCashier}	</td>
                                                        <td>{item.PayOutCashier}</td>
                                                        ...
                                                        <td><span class="badge badge-light-info fs-5">Pendding</span></td>
                                                        <td>
