...
function CustomerView() {
  ...
  const [sendindAmount, setsendindAmount] = useState();
  const [cust_organisation, setcust_organisation] = useState([]);
  ...
  const userlist = async () => {
    ...
    await axios
      ...
      .then((res) => {
        ...
        setData(userData);
        setreceiveAmount(userData.receiveAmount);
        setsendindAmount(userData.sendindAmount);
        console.log("bank  accound information", res);
  ...
  const handleVerfiy = (_id) => {
    ...
    const { custID } = { custID: _id };
    console.log(custID);
    axios.post(`/updateDigitalID/${custID}/${adminID}`).then((resp) => {
      if (resp.status) {
        let data = resp.data;
        // setData(data)
        // console.log(data);
  ...
  const accountlist = async () => {
    await axios.post(`/customer_bank/${custID}`).then((resp) => {
      let data = resp.data.findCust;
      setAccount(data);
    });
  };
  const adminorgination = async () => {
    const { custID } = { custID: _id };
    await axios.post(`/cust_organisation/${custID}`)
    .then((resp) => {
      let data = resp.data.final;
      setcust_organisation(data);
      console.log("orgination data2222222222222222222222222222222222222222222222222222222222",data ,resp)
    });
  };
                                  ...
                                  <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    <div className="d-flex align-items-center">
                                      ...
                                      <div
                                        ...
                                        data-kt-countup-value={`$${data.totalAmount}`}
                                ...
                                <div className="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
                                  ...
                                  <div className="h-5px mx-3 w-100 bg-light mb-3">
                                    <div
                                      ...
                                      style={{
                                        width: `${data.proPercentage}%`,
                                      }}
                                      role="progressbar"
                                      aria-valuenow={data.proPercentage}
                                      aria-valuemin="0"
                                      aria-valuemax="100"
                                    ></div>
                                  </div>
                      ...
                      <div className="card-body">
                        <div className="d-flex flex-stack animation-css">
                          <div className="d-flex align-items-center jus me-3">
                            ...
                            <img
                              src="../assets_new/images/digitalid-03.png"
                          ...
                          <div className="d-flex justify-content-end align-items-center w-100 mw-125px">
                            ...
                            {data.fingerPrint == 1 ? (
                              <>
                                <img
                                  src="../assets_new/images/digital-04.png"
                                  width="25px"
                                />
                              </>
                            ) : (
                        ...
                        <div className="d-flex flex-stack animation-css">
                          <div className="d-flex align-items-center me-3">
                            {/* <!--begin::Icon--> */}
                            <img
                              src="../assets_new/images/icons-16.png"
                              className="me-3 w-30px"
                              alt=""
                            />
                            {/* <!--end::Icon--> */}
                        ...
                        <div className="d-flex flex-stack animation-css">
                          <div className="d-flex  align-items-center me-3">
                            {/* <!--begin::Icon--> */}
                            <img
                              src="../assets_new/images/address.png"
                              className="me-3 w-30px"
                              alt=""
                            />
                            {/* <!--end::Icon--> */}
                        ...
                        <div className="d-flex align-items-center ">
                          <div className="activediv d-flex flex-column align-items-start justift-content-center flex-equal me-5">
                            <h1 className="fw-bold fs-4 fs-lg-1 text-white mb-5 mb-lg-10">
                              <span id="replce">
                                D-ID Ref : #######{digitalrefID}
                              </span>
                              &nbsp;
                              <span id="replce1">
                                D-ID Ref : {data.digitalrefID}
                              </span>
                              &nbsp;
                              <button
                                type="button"
                              ...
                              >
                                <span className="svg-icon svg-icon-3">
                                  ...
                                  <img
                                    src="/assets_new/images/png-02.png"
                                    width="28px"
                                  />
                                </span>
                              </button>
                          ...
                          >
                            <li className="nav-item my-1" role="presentation">
                              <a
                                ...
                                data-bs-toggle="tab"
                                href="#overview"
                                className="btn btn-color-gray-600 btn-active-secondary  active btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-7 mx-1 text-uppercase"
                              >
                                Overview
                              </a>
                            </li>
...
<div className="overflow-scroll">
                      <Chart
                        ...
                        width={350}
                        height={100}
                        series={[receiveAmount, sendindAmount, 3000]}
                        options={{
                          labels: ["Depost", "withdrawal", "other"],
                          colors: ["#f1416c", "#3c7f8c", "#e4e6ef"],
                          dataLabels: {
                            enabled: false,
                          },
                        }}
                                    ...
                                    <div className="bg-gray-100 ative animestion-bank bg-opacity-70 rounded-2 px-6 py-5">
                                      ...
                                      <div className="m-0">
                                        <span className="bank-logo  text-center text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">
                                          <img
                                            src="../assets_new/images/logo5.png"
                                            width="100px"
                                          />
                                        </span>
                                    ...
                                    <div className="mb-10">
                                      ...
                                      <div>
                                        <select
                                          ...
                                          data-dropdown-parent="#kt_menu_62d4f2ee25eea"
                            ...
                            <div className="card-body pt-5">
                              <div className="timeline-label">
                                <div className="timeline-item">
                                  ...
                                  <div className="fw-mormal timeline-content text-green ps-3">
                                    Chromepay login
                                  </div>
                                </div>
                                ...
                                <div className="timeline-item">
                                  ...
                                  <div className="timeline-content fw-mormal text-green ps-3">
                                    Linked to Bank of Oromia
                                  </div>
                                </div>
                        ...
                        <div className="col-lg-6">
                          <div className="card card-flush">
                            ...
                            <div className="card-body mt-n20">
                              <div className="mt-n20 position-relative">
                                <div className="row g-3 g-lg-6">
                            {cust_organisation.map(item=>   <div className="col-6">
                                    <div className="bg-gray-100 animestion-bank bg-opacity-70 rounded-2 px-6 py-5">
                                      <div className="symbol symbol-30px me-5 mb-8">
                                        <span className="symbol-label">
                                          <span className="svg-icon svg-icon-1 svg-icon-primary">
                                  ...
                                  {/* <div className="col-6">
                                    <div className="bg-gray-100 animestion-bank bg-opacity-70 rounded-2 px-6 py-5">
                                      ...
                                      <div className="m-0">
                                        <span className="bank-logo text-center text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">
                                          <img
                                            src={cust_organisation.logo}
                                            width="65px"
                                          />
                                        </span>

                                        <span className="text-gray-500 fw-semibold fs-6">
                                        {cust_organisation.name}
                                        </span>
                                      </div>
                                    </div>
                                  </div> */}
                              ...
                              <div className="row mb-7">
                                <label className="col-lg-4 fw-semibold text-muted">
                                  ...
                                  <i
                                    className="fas fa-exclamation-circle ms-1 fs-7"
                                    data-bs-toggle="tooltip"
                                    title="Phone number must be verified"
                                  ></i>
                                </label>
                              ...
                              <div className="m-0">
                                <div className="d-flex align-items-center mb-2">
                                  <span className="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2">{`$${
                                    data.sendindAmount + data.receiveAmount
                                  }`}</span>
