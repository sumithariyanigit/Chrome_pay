                                        ...
                                        <div className="d-flex flex-column flex-grow-1 pe-8">
                                            ...
                                            <div className="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
                                                ...
                                                <div className="h-5px mx-3 w-100 bg-light mb-3">
                                                    <div className="bg-success rounded h-5px " style={{width:`${data.proPercentage}%`}}  role="progressbar"  aria-valuenow={data.proPercentage} aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="col-6">
                                                    ...
                                                    <div className="bg-gray-100 ative animestion-bank bg-opacity-70 rounded-2 px-6 py-5">
                                                        ...
                                                        <div className="m-0">
                                                            ...
                                                            <span className="text-gray-500 fw-semibold fs-6">{data.walletAddress}</span>
