...
function AgentReportView() {
    ...
    const [listtransaction , setTransactionList] =useState([]);
    const [commission, setComission] = useState([]);
    
    const userlist = async () => {
        const {ID} = {ID :_id}
        await axios.post(`/recentAgentUser/${ID}`)
        .then(resp =>{
            let data = resp.data.final
            const user = resp.data.totalCustomer
            const transaction = resp.data.NumberOfTransection
            const total = resp.data.totalTransection
    ...
    const transactionlist = async () =>{
        await axios.get(`/recentTransection`)
        .then(resp =>{
    ...
    const commissionlist = async () => {
        ...
        await axios.post(`/ViewAgentCommmission/${agentID}`)
        .then(resp =>{
            let data = resp.data.lastUpdate
            setComission(data);
            console.log('pushpak===>>>',data)
                                                ...
                                                <div className="row g-3 g-lg-6">
                                                    ...
                                                    <div className="col-6">
                                                        ...
                                                        <div className="retative bg-gray-100 ative animestion-bank bg-opacity-70 rounded-2 px-6 py-5">
                                                            ...
                                                            <div className="m-0">
                                                                <span data-kt-countup="true" data-kt-countup-value={user} className="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">
                                                                    {user}</span>
                                                    ...
                                                    <div className="col-6">
                                                        ...
                                                        <div className="retative bg-gray-100 animestion-bank bg-opacity-70 rounded-2 px-6 py-5">
                                                            ...
                                                            <div className="m-0">
                                                                <span data-kt-countup="true" data-kt-countup-value={`$${total}`} data-kt-countup-prefix="$" className="text-gray-700  fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">
                                                                {`$${total}`}</span>
                                                                <span className="text-gray-500 fw-semibold fs-6">
                                                    ...
                                                    <div className="col-4">
                                                        ...
                                                        <div className="retative bg-gray-100 animestion-bank bg-opacity-70 rounded-2 px-6 py-5">
                                                            ...
                                                            <div className="m-0">
                                                                <span data-kt-countup="true" data-kt-countup-value={transaction} className="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">
                                                                    {transaction}</span>
                                                                <span className="text-gray-500 fw-semibold fs-6">
                                                                    Number Of Transaction </span>
                                                            </div>
                                                    ...
                                                    <div className=" retative bg-gray-100 animestion-bank bg-opacity-70 rounded-2 px-6 py-5">
                                                        ...
                                                        <div className="m-0">
                                                            <span data-kt-countup="true" data-kt-countup-value={`${commission.Amount} %`} className="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">
                            ...
                            <div className="card card-xxl-stretch mb-5 mb-xl-8">
                                ...
                                <div className="card-header border-0 pt-5">
                                    <h3 className="card-title align-items-start flex-column">
                                        ...
                                        <span className="text-muted mt-1 fw-semibold fs-7">Over {user} Customer</span>
                                    </h3>
                ...
                <div className="card card-xxl-stretch mb-5 mb-xl-8">
                    ...
                    <div className="card-header border-0 pt-5">
                        <h3 className="card-title align-items-start flex-column">
                            ...
                            <span className="text-muted mt-1 fw-semibold fs-7">Over {transaction} Customer</span>
                        </h3>
