...
// {
// console.warn(_id);
// axios.put(`/Unsuspendcustomer/${_id}`)
// .then(res =>{
//     if(res.status){
//         let data = res.data;
  ...
  const handledelete = (_id) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {  
            const {ID} ={ID : _id}       
            axios.put(`/Unsuspendcustomer/${ID}/${adminID}`)
            .then(res => {
                if (res.status) {
                    let data = res.data;
                    if (data.status) { 
                                ...
                                <div className="card bg_card rounded-15 bgi-no-repeat bgi-position-x-end bgi-size-cover" style={{ marginTop: '2rem' }}>
                                    ...
                                    <div className="card-body container-xxl pt-10 pb-8">
                                        ...
                                        <div className="d-flex align-items-center">
                                            ...
                                            <span className="fw-semibold text-white opacity-50"> Blocked Customers</span>
                                        </div>
                                ...
                                <div className="card card-xxl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div className="card-header border-0 pt-5">
                                        <h3 className="card-title align-items-start flex-column">
                                            <span className="card-label fw-bold fs-3 mb-1">Customers Block List</span>
                                            ...
                                            <table className="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                                ...
                                                <thead>
                                                    <tr className="fw-bold text-muted th-title">
                                                        ...
                                                        <th className="min-w-125px">DigitalID</th>
                                                        ...
                                                        <td>
                                                            ...
                                                            {/* {item.blocked == 1 ? <> 
                                                               ...
                                                               <img src="/assets_new/images/suspand.png" width="20px" />
                                                                ...
                                                                {menu.unBlockCustomer == 1 ? <><button onClick = {(e) => { handledelete(item._id) ;}}
                                                                    className="btn btn-icon btn-detail btn-active-color-primary btn-sm me-1 mr-4"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
