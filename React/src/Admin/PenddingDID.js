...
const fetchComments = async (page) => {
   ...
   axios.post(`/approvalDIDs`, senData)
        .then(resp => {
            const data = resp.data.findCust;
            setData(data);
        })
                                                        ...
                                                        {/* <td>{item.receiverAmount}</td> */}
                                                         <td>
                                                            <div className="d-flex justify-content-end flex-shrink-0">
                                                                ...
                                                                <button onClick={(e)=>{ handleAproove(item._id)}}
                                                                    className="btn btn-icon btn-detail btn-active-color-primary btn-sm me-1 mr-4"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    data-bs-trigger="hover" title="Approve">
                                                                    <span className="svg-icon svg-icon-3">
                                                                        {/* <i className="fad fa-eye fs-4"></i> */}
                                                                        <img src="/assets_new/images/approve.png" width="25px" />
                                                                    </span>
