...
function OrganzationPerfomance() {
     const {_id} =useParams();
    ...
    const UserPermoance = async () => {
        ...
        await axios.post(`/OrgPerreort/${orgID}`)
            .then(res => {
    ...
    const UserPermoanceyear = async () => {
        ...
        await axios.post(`/org_add_cust/${orgID}`)
            .then(res => {
...
<div className="d-flex justify-content-between align-items-start flex-wrap mb-2">
    ...
    <div className="d-flex flex-column">
        ...
        <div className="d-flex align-items-center mb-2">
            <a href="#" className="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{section.name}</a>
            <a href="#">
        ...
        <div className="d-flex flex-wrap">
            ...
            <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                ...
                <div className="d-flex align-items-center">
                    ...
                    <div className="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value={section.totalUser} data-kt-countup-prefix="$">{section.totalUser}</div>
                </div>
            ...
            <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                ...
                <div className="d-flex align-items-center">
                    ...
                    <div className="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value={section.totalTransection}>{section.totalTransection}</div>
                </div>
...
<div className=" ">
<span data-kt-countup="true" data-kt-countup-value="1000" className="text-gray-700 fz-230 mt-3 fw-bolder d-block fs-4qx lh-1 ls-n1 mb-1  " >
1000</span>
<h6 className="nz-2">
<span className="text-gray-500 fw-semibold fs-6  ">
...
export default OrganzationPerfomance