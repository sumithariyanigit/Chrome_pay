                                    ...
                                    >
                                        ...
                                        <div className="card-body container-xxl pt-10 pb-8">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                <span className="fw-semibold text-white opacity-50">Digital Customers
                                                    List</span>
                                            </div>
                                    ...
                                    <div className="card card-xxl-stretch mb-5 mb-xl-8">
                                        ...
                                        <div className="card-header border-0 pt-5">
                                            <h3 className="card-title align-items-start flex-column">
                                                <span className="card-label fw-bold fs-3 mb-1">DIGITAL CUSTOMERS LIST</span>
                                                ...
                                                <table
                                                    ...
                                                    <thead>
                                                        <tr className="fw-bold text-muted th-title">
                                                            ...
                                                            <th className="min-w-200px">ID Photo</th>
                                                            ...
                                                            <th className="min-w-100px text-center">Biometric</th>
                                                            <th className="min-w-100px text-center">Fingerprint</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div className="d-flex align-items-center">
                                                                    <div className="symbol symbol-45px me-5">
                                                                        <img src="assets_new/images/jassica.PNG" alt="" />
                                                                    </div>
                                                                    <div className="d-flex justify-content-start flex-column">
                                                                        <a href="#" className="usertitle mb-2">Jessica
                                                                            Chinara</a>
                                                            ...
                                                            <td>
                                                                <span
                                                                    className="text-dark text-hover-primary d-block fs-4">Chromepay</span>

                                                            </td>
                                                            <td>D-ID Ref:#######655</td>
                                                            <td><span
                                                                className="text-dark text-hover-primary d-block fs-4">15/02/2021</span>
                                                            </td>
                                                            <td><span
                                                                className="text-dark text-hover-primary d-block fs-4">Ethiopia</span></td>

                                                            <td className="text-center">

                                                                <span className="svg-icon svg-icon-muted svg-icon-2hx faild"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    data-bs-trigger="hover" title="Biometric	 Rejected"><svg
                                                                        xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        height="24" viewBox="0 0 24 24" fill="none">
                                                                        <path opacity="0.3"
                                                                            d="M20.5543 4.37824L12.1798 2.02473C12.0626 1.99176 11.9376 1.99176 11.8203 2.02473L3.44572 4.37824C3.18118 4.45258 3 4.6807 3 4.93945V13.569C3 14.6914 3.48509 15.8404 4.4417 16.984C5.17231 17.8575 6.18314 18.7345 7.446 19.5909C9.56752 21.0295 11.6566 21.912 11.7445 21.9488C11.8258 21.9829 11.9129 22 12.0001 22C12.0872 22 12.1744 21.983 12.2557 21.9488C12.3435 21.912 14.4326 21.0295 16.5541 19.5909C17.8169 18.7345 18.8277 17.8575 19.5584 16.984C20.515 15.8404 21 14.6914 21 13.569V4.93945C21 4.6807 20.8189 4.45258 20.5543 4.37824Z"
                                                                            fill="currentColor" />
                                                                        <rect x="9" y="13.0283" width="7.3536"
                                                                            height="1.2256" rx="0.6128"
                                                                            transform="rotate(-45 9 13.0283)"
                                                                            fill="currentColor" />
                                                                        <rect x="9.86664" y="7.93359" width="7.3536"
                                                                            height="1.2256" rx="0.6128"
                                                            ...
                                                            <td className="text-center ">
                                                                ...
                                                                <span className="svg-icon svg-icon-muted svg-icon-2hx success"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    data-bs-trigger="hover"
                                                                    title="Fingerprint Verified"><svg
                                                                        xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        height="24" viewBox="0 0 24 24" fill="none">
                                                                        <path opacity="0.3"
                                                                            d="M20.5543 4.37824L12.1798 2.02473C12.0626 1.99176 11.9376 1.99176 11.8203 2.02473L3.44572 4.37824C3.18118 4.45258 3 4.6807 3 4.93945V13.569C3 14.6914 3.48509 15.8404 4.4417 16.984C5.17231 17.8575 6.18314 18.7345 7.446 19.5909C9.56752 21.0295 11.6566 21.912 11.7445 21.9488C11.8258 21.9829 11.9129 22 12.0001 22C12.0872 22 12.1744 21.983 12.2557 21.9488C12.3435 21.912 14.4326 21.0295 16.5541 19.5909C17.8169 18.7345 18.8277 17.8575 19.5584 16.984C20.515 15.8404 21 14.6914 21 13.569V4.93945C21 4.6807 20.8189 4.45258 20.5543 4.37824Z"
                                                            ...
                                                            <td><span className="badge badge-light-info fs-5">In progress</span>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div className="d-flex justify-content-end flex-shrink-0">
                                                                    ...
                                                                    <a href="#"
                                                                        className=" btn btn-icon btn-sucess1 btn-active-color-primary btn-sm mr-4"
                                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                                        data-bs-trigger="hover" title="Verify User">
                                                                        <span className="svg-icon svg-icon-3">
                                                                            <i className="fad fa-badge-check fs-4"></i>
                                                                        </span>
                                                        ...
                                                        <tr>
                                                                ...
                                                                <div className="d-flex align-items-center">
                                                                    ...
                                                                    <div className="d-flex justify-content-start flex-column">
                                                                        ...
                                                                        <span className="font-icon mb-1">
                                                                            ...
                                                                            +351 123-456-7890</span>

                                                                        <span className="font-icon mb-1">
                                                                            <span className="">
                                                                                <i className="fal fa-envelope"></i>
                                                                            </span>
                                                                            arpitjain@gmail.com </span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td className="text-center">
                                                                ...
                                                                <span className="svg-icon svg-icon-muted svg-icon-2hx faild"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    data-bs-trigger="hover" title="Fingerprint	 Rejected"><svg
                                                                        xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        height="24" viewBox="0 0 24 24" fill="none">
                                                                        <path opacity="0.3"
                                                                            d="M20.5543 4.37824L12.1798 2.02473C12.0626 1.99176 11.9376 1.99176 11.8203 2.02473L3.44572 4.37824C3.18118 4.45258 3 4.6807 3 4.93945V13.569C3 14.6914 3.48509 15.8404 4.4417 16.984C5.17231 17.8575 6.18314 18.7345 7.446 19.5909C9.56752 21.0295 11.6566 21.912 11.7445 21.9488C11.8258 21.9829 11.9129 22 12.0001 22C12.0872 22 12.1744 21.983 12.2557 21.9488C12.3435 21.912 14.4326 21.0295 16.5541 19.5909C17.8169 18.7345 18.8277 17.8575 19.5584 16.984C20.515 15.8404 21 14.6914 21 13.569V4.93945C21 4.6807 20.8189 4.45258 20.5543 4.37824Z"
