...
const org_dtl = async () =>{
  ...
  const getData = async (formData) => 
              {  try{
                  let response = await axios.get('/feature_list',formData,options);
...
/////////////////////////////////////////////////////////////
      ...
      let Formvlaues = Object.fromEntries(data.entries());  
            ...
            try{
              let response = await axios.post('/add_org',Formvlaues,{ headers:{"Content-type": "application/json" }});
 ...
 <div className="container">
      <div className="row text-center " data-aos="fade-down" data-aos-delay="400">
        <div className="col-lg-12 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up" className=""><span><b>Add Organization</b></span></h1>
        </div>
      </div>
      <div className="row">
        <div className="path2 " data-aos="fade-left" data-aos-delay="400">
          <a href="#">Dashboard</a> - <span>Add Organization</span>
        </div>
      </div>
    </div>
</section>
    ...
    <div className="container">
        ...
        <div className="col-lg-12 mb-3">
          ...
          <form id = 'FormID' onSubmit={(e)=>hendalSubmit(e)}>
            ...
            <div className="row">
              <div className="table-title">
               <h5 className="mb-4">Number of customer</h5>
              </div>
               <div className="col-md-4  mb-2" data-aos="fade-down" data-aos-delay="100">
                <div className="form-floating mb-3">
                  <input type="number" className="form-control"  name = 'cust_count' />
                  <label for="floatingInput">Number of customer</label>
                </div>
              </div>
             </div>
              <div className="row">
              <div className="table-title">
               <h5 className="mb-4">Number of license</h5>
              </div>
               <div className="col-md-4  mb-2" data-aos="fade-down" data-aos-delay="100">
                <div className="form-floating mb-3">
                  <input type="number" className="form-control" name = 'license_count' />
                  <label for="floatingInput">Number of license</label>
                </div>
              </div>
             </div>
...
export default Add_rganization;