...
function AgentBlockedDIDs() {
  ...
  const userlist = async () => {
        await axios.post(`/agent_blocked/${agentID}`)
            .then(resp => {
...
const fetchComments = async (page) => {
   ...
   axios.post(`/agent_blocked/${agentID}`, senData)
        .then(resp => {
                                ...
                                <div className="card card-xxl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div className="card-header border-0 pt-5">
                                        <h3 className="card-title align-items-start flex-column">
                                            <span className="card-label fw-bold fs-3 mb-1">Block List</span>
...
export default AgentBlockedDIDs