...
const [show, setShow] = useState(false);
  ...
  const AddFormData = async (e) =>{
    ...
    axios.post(`/Cust_Linked_Srevice`,formData)
    .then(resp =>{
   ...
   <Modal show={show} onHide={() => setShow(false)}>
        ...
        <Modal.Body>
             ...
             <div className="col-lg-12 ">
                ...
                <select className="form-select border-0 flex-grow-1" data-control="select2" data-placeholder="organisation"
