 ...
 // var token = Jwt.decode(token1);
  ...
  const customerlist = async () => {
    ...
    await axios.post(`/custdetail/${custID}`)
      .then(resp => {
        let data1 = resp.data.obj;
        setlistcustomer(data1);
        console.log( "customer list222222 ",data1);
      })
  }
  ...
  const userDocumentview = async () => {
    ...
    await axios.post(`/get_document/${custID}`)
      .then(resp => {
        ...
        console.log("selected document55555555555555", data);
      })
  }

  console.log("selected document2", findDocuments.locaDocument);
  ...
  const loanformhandler =(e)=>{
    ...
    axios.post(`/calculate_Amount/${token}`,Formvlaues)
    .then(res =>{
        if(res.status){
        let data =res.data;
            if(data.status){
                toast.success(data.msg)
                window.location = `/Customerloanlist`
            }else{
...
const AddFormotp =(e)=>{
  e.preventDefault();
    let { custID } = { custID: _id }
    alert(custID)
    axios.post(`/send_Loan_Otp/${custID}`)
    .then(res=>{
      if(res.status){
        let data =res.data;
            if(data.status){
                            ...
                            <div className="d-flex flex-wrap flex-sm-nowrap mb-3">
                                ...
                                <div className="me-7 mb-4">
                                    <div className="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                        <img src={listcustomer.IDphoto} alt="image" />
                                    ...
                                    <div className="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                        ...
                                        <div className="d-flex flex-column">
                                            ...
                                            <div className="d-flex align-items-center mb-2">
                                                ...
                                                <a href="#" className="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{listcustomer.fullname}
                                                   </a>
                                                <a href="#">
                                        ...
                                        <div className="d-flex flex-column flex-grow-1 pe-8">
                                            ...
                                            <div className="d-flex flex-wrap">
                                                ...
                                                <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div className="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value={listcustomer.totalAmount} data-kt-countup-prefix="$">{listcustomer.totalAmount}</div>
                                                    </div>
                                                ...
                                                <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div className="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value={listcustomer.totalTransection}>{listcustomer.totalTransection}</div>
                                                    </div>
                                            ...
                                            <div className="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
                                                <div className="d-flex justify-content-between w-100 mt-auto mb-2">
                                                    ...
                                                    <span className="fw-bold fs-6">{listcustomer.proPercentage}%</span>
                                                </div>
                                                <div className="h-5px mx-3 w-100 bg-light mb-3">
                                                <div className="bg-success rounded h-5px " style={{width:`${listcustomer.proPercentage}%`}}  role="progressbar"  aria-valuenow={listcustomer.proPercentage} aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
 ...
 <img src="../assets_new/images/digital-04.png" width="25px" />
                            ...
                            <div className="d-flex flex-stack animation-css">
                                ...
                                {listcustomer.facialIdentification==1?
 <img src="../assets_new/images/digital-04.png" width="25px" />
                                    :   <img src="../assets_new/images/cross.png" width="23px" />
  }
...
<label className="col-lg-4 col-form-label required fw-semibold fs-6">Intrest Rate</label>
        ...
        <div className="col-lg-8 fv-row">
            <input type="text" name="Interest" className="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder=" type Intrest Rate" readOnly defaultValue={interestbranch[1]}  />
        </div>
...
<label className="col-lg-4 col-form-label  required fw-semibold d-none fs-6">custID</label>

        <div className="col-lg-8 fv-row">
            <input type="text" name="custID" className="form-control d-none form-control-lg form-control-solid mb-3 mb-lg-0" placeholder=" enter custID" defaultValue={custID}  />
            ...
            <input type="text" name="otp" className="form-control  form-control-lg d-none form-control-solid mb-3 mb-lg-0" placeholder=" enter otp" value={otp} defaultValue={otp} />
        </div>
...
<label className="col-lg-4 col-form-label required fw-semibold fs-6">OTP </label>

      <div className="col-lg-4 fv-row">
          <input type="text" name="otp" className="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder=" enter otp" onChange={(e)=>setotp(e.target.value)} />
      </div>
      <div className="col-lg-4 fv-row">
      <button type="button" className="btn btn-light btn-active-light-primary me-2" onClick={(e)=>AddFormotp(e)}>Get otp</button>
      </div>
...
<div className="card-footer d-flex justify-content-end py-6 px-9">
                                        <button type="submit" className="btn btn-light btn-active-light-primary me-2"onClick={() => handleShow()} >Submit</button>
        ...
        <div className="row">
                <div className="col-lg-12 mb-4">
                  <h2 className="fw-bold mt-5">User Documents
              
                {findDocuments==null? <img src="/assets_new/images/verify.png" width="28px"  style={{marginLeft:"1rem"}}/>:""} </h2>
                </div>
      ...
      {/* <Modal show={showotp} onHide={() => setshowotp(false)}>
        <Modal.Header closeButton>
          <Modal.Title>Loan Apply</Modal.Title>
        </Modal.Header>
        <form>
        <Modal.Body>
             <div className="col-lg-12 ">
                      <label className="mb-2">OTP</label>
                      <input className="form-control" placeholder="Enter your otp"  type="number" name="otp" onChange={(e)=>setotp(e.target.value)}/>
                    </div>
        </Modal.Body>
        <Modal.Footer>
          <Button variant="primary" type="submit">  Submit Now
          </Button>
        </Modal.Footer>
        </form>
      </Modal> */}
