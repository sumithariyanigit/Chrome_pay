...
function ExportCustomerDIDs() {
    ...
    //const agentID = localStorage.getItem('agentID')
      ...
      const AddFormData =async (e, page) =>{
        ...
        axios.post(`/ExportAgentCust/${token}`, formData)
        .then(resp => {
      ...
      await axios.post(`/ExportAgentCust/${token}`)
      .then(resp =>{
                                ...
                                <div className="card card-xxl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div className="card-header border-0 pt-5">
                                        <h3 className="card-title align-items-start flex-column">
                                            <span className="card-label fw-bold fs-3 mb-1">Coustomer List</span>
...
export default ExportCustomerDIDs