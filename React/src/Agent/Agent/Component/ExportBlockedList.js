...
function ExportBlockedList() {
    ...
    //const agentID = localStorage.getItem('agentID')
      ...
      const AddFormData =async (e, page) =>{
        ...
        axios.post(`/ExportAgentBlockedCust/${token}`, formData)
        .then(resp => {
      ...
      await axios.post(`/ExportAgentBlockedCust/${token}`)
      .then(resp =>{
                                ...
                                <div className="card card-xxl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div className="card-header border-0 pt-5">
                                        <h3 className="card-title align-items-start flex-column">
                                            <span className="card-label fw-bold fs-3 mb-1">Blocked List</span>
...
export default ExportBlockedList