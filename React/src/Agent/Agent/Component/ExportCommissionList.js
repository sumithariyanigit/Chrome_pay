...
function ExportCommissionList() {
    ...
    //const agentID = localStorage.getItem('agentID')
      ...
      const AddFormData =async (e, page) =>{
        ...
        axios.post(`/ExportCommissionList/${token}`, formData)
        .then(resp => {
            let data = resp.data.findCommission;
            setData(data);
      ...
      await axios.post(`/ExportCommissionList/${token}`)
      .then(resp =>{
        const data =resp.data.findCommission;
        console.log(data);
        setData(data);
        const total =resp.data.totlaRow;
        console.log(total);
                                ...
                                <div className="card card-xxl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div className="card-header border-0 pt-5">
                                        <h3 className="card-title align-items-start flex-column">
                                            <span className="card-label fw-bold fs-3 mb-1">Commision List</span>
...
export default ExportCommissionList