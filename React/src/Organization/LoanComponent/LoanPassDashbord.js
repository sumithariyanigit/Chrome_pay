                                        ...
                                        <form  id="kt_account_profile_details_form" className="form" >
                                            <div className="card-body border-top p-9">
                                                ...
                                                <div className="row mb-8">
                                                    ...
                                                    <div className="col-lg-6 mb-6">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-lg-8 fv-row">
                                                                <input type="text" name="OrganisationID" value={OrgName} className="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Full Name" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="col-lg-6  mb-8 ">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-lg-8 fv-row">
                                                                <input type="text" name="Loan_type" value={data.Loan_ID} className="form-control form-control-lg form-control-solid" placeholder="Email Address" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-6  mb-8 ">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-lg-8 fv-row">
                                                                <input type="text" name="No_Of_Installment" value={data.No_Of_Installment} className="form-control form-control-lg form-control-solid" placeholder="Phone number" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-6 mb-8">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-lg-8 fv-row">
                                                                <input type="text" name="remainig_Insallment" value={data.remainig_Insallment} className="form-control form-control-lg form-control-solid" placeholder="country" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-6 mb-6">
                                                        <div className="row ">
                                                            ...
                                                            <div className="col-lg-8 fv-row">
                                                                <input type="text" name="EMI" value={data.Complete_insallment} className="form-control form-control-lg form-control-solid" placeholder="City" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-6 mb-6">
                                                        <div className="row ">
                                                            ...
                                                            <div className="col-lg-8 fv-row">
                                                                <input type="text" name="Installment_Amount" value={data.Installment_Amount} className="form-control form-control-lg form-control-solid" placeholder="Address" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="col-lg-6 ">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-lg-8 fv-row">
                                                                <input type="text" name="Interest_Rate" value={data.Interest_Rate} className="form-control form-control-lg form-control-solid position-relative" placeholder="Post Code" />
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div className="col-lg-6 mb-6">
                                                        <div className="row ">
                                                            ...
                                                            <div className="col-lg-8 fv-row">
                                                                <input type="text" name="Total_Duration" value={data.Total_Duration} className="form-control form-control-lg form-control-solid" placeholder="50000$" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="col-lg-6 mb-6">
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col-lg-8 fv-row">
                                                                <input type="text" name="Installment_Pay_Date" value={moment(data.Installment_Pay_Date).format("DD/MM/YYYY")} className="form-control form-control-lg form-control-solid" placeholder="50000$" />
                                                            </div>
                                                ...
                                                <label className="col-lg-4 col-form-label required fw-semibold fs-6">Start Date</label>
                                                    <div className="col-lg-8 fv-row">
                                                    <input type="text" name="start_Date" value={moment(data.start_Date).format("DD/MM/YYYY")} className="form-control form-control-lg form-control-solid position-relative" placeholder="limit" />
                                                    </div>
                                                </div>
                                                    ...
                                                    <div className="col-lg-6 mb-6">
                                                        <div className="row ">
                                                            ...
                                                            <div className="col-lg-8 fv-row">
                                                                <input type="text" name="End_Date" value={moment(data.End_Date).format("DD/MM/YYYY")} className="form-control form-control-lg form-control-solid" placeholder="Amount" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-6 mb-6">
                                                        <div className="row ">
                                                            ...
                                                            <div className="col-lg-8 fv-row">
                                                                <input type="text" name="End_Date" value="Null" className="form-control form-control-lg form-control-solid" placeholder="Amount" />
                                                            </div>
                                                        </div>
                                                    </div>
...
export default LoanPassDashbord