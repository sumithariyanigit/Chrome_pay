...
var jwt = require("jsonwebtoken");
 ...
 function AddCustomer() {
    ...
    const AddFormData = async (e) => {
        ...
        axios.post(`/createCustomerByOrg/${orgID}`, dataToSend2)
                .then(res => {
                    if (res.status) {
                        let data = res.data;
                        if (data.status) {
                                ...
                                <form onSubmit={(e) => AddFormData(e)} id="kt_account_profile_details_form" className="form" >
                                    <div className="card-body border-top p-9">
                                        ...
                                        <div className="row mb-6">
                                            ...
                                            <div className="col-lg-8 fv-row">
                                                <input type="text" name="age"  className="form-control form-control-lg form-control-solid" placeholder="age" />
                                            </div>
                                        </div>
                                        <div className="row mb-6">
             ...
             <select className="form-select border-0 flex-grow-1"
                            ...
                            <option key={item._id} value={item._id}>{item.name}</option>
                                        ...
                                        <div className="row mb-6">
                                            ...
                                            <label className="col-lg-4 col-form-label  fw-semibold fs-6">Local Document Image</label>
                                        ...
                                        <div className="row mb-6">
                                            ...
                                            <label className="col-lg-4 col-form-label  fw-semibold fs-6">Land Registration</label>
                                    ...
                                    <div className="card-footer d-flex justify-content-end py-6 px-9">
                                        <button onClick={handleClick} type="submit" className="btn btn-light btn-sub me-2">Submit</button>
